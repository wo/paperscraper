...
namespace ocropus {
    ...
    void CharStats::get_char_boxes(rectarray &comps){
    ...
    void CharStats::calc_char_stats(){
        calc_char_stats(char_boxes);
    }
    
    void CharStats::calc_char_stats(rectarray &cboxes){
        if(!cboxes.length()){
    ...
    void CharStats::calc_char_stats_for_one_line(){
        calc_char_stats_for_one_line(char_boxes);
    }

    void CharStats::calc_char_stats_for_one_line(rectarray &cboxes){
        if(!cboxes.length()){
            fprintf(stderr,"No character boxes found! ...\n");
            return ;
        }
