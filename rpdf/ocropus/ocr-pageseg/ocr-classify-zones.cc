...
namespace ocropus {
    ...
    void ZoneFeatures::compress_hist(intarray &histogram){
    ...
    void ZoneFeatures::compress_2dhist(intarray &histogram_2D){
    ...
    void ZoneFeatures::horizontal_run_lengths(floatarray &resulthist,
        ...
        compress_hist(histogram_fg);
        compress_hist(histogram_bg);
    ...
    void ZoneFeatures::vertical_run_lengths(floatarray &resulthist,
                                            floatarray &resultstats,
                                            const bytearray &image){
    ...
    void ZoneFeatures::main_diag_run_lengths(floatarray &resulthist,
                                             floatarray &resultstats,
                                             const bytearray &image){
    ...
    void ZoneFeatures::side_diag_run_lengths(floatarray &resulthist,
                                             floatarray &resultstats,
                                             const bytearray &image){
    ...
    void ZoneFeatures::concomp_hist(floatarray &result, 
                                    rectarray &concomps){
        ...
        compress_hist(histogram_width);
        compress_hist(histogram_height);
        compress_2dhist(histogram_2D);
    ...
    void ZoneFeatures::concomp_neighbors(floatarray &result, 
                                         rectarray &concomps){
        ...
        compress_hist(histogram);
        for(int i=0, l=histogram.length(); i<l; i++)
            result.push(histogram[i]);

    }

    void ZoneFeatures::extract_features(floatarray &feature, bytearray &image){
        ...
        // RUNNING LENGTHS
        floatarray rl_stats;
        horizontal_run_lengths(feature,rl_stats,image);
        vertical_run_lengths(feature,rl_stats,image);
        main_diag_run_lengths(feature,rl_stats,image);
        side_diag_run_lengths(feature,rl_stats,image);
        ...
        concomp_hist(feature, boxes);
        concomp_neighbors(feature, boxes);
