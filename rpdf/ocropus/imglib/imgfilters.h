...
namespace imglib {
    ...
    void horn_riley_ridges(colib::floatarray &im,colib::floatarray &zero,colib::floatarray &strength,colib::floatarray &angle);
    void laplacian(colib::floatarray &result,colib::floatarray &image);
